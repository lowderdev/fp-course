...
-- True
hex :: Parser Char
-- is UnexpectedString right here? Or should it be (valueParser 0)?
hex = parseHexDigits >>= (optional (pure . chr) (P UnexpectedString) . readHex)
  where
    parseHexDigits = replicateA 4 (satisfy isHexDigit)
...
--
-- /Tip:/ Use `sequence` and @Data.List#and@. Should this be Course.List.List.and?
--
